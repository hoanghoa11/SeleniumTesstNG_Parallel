package com.hoa.Bai29_DataProvider;

import com.hoa.dataprovider.DataProviderFactory;
...
public class DemoDataProvider {
    ...
    public void testLoginFromExcelFileMultipleRow(Hashtable<String, String> data) {
        ...
        System.out.println("PASSWORD: " + data.get("password")); //password là tên cột trong file excel (dòng đầu) nhớ phân biet hoa thương
    }
